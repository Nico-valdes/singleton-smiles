    ...
    <SiteShell>
      <section className="border-b border-slate-100 bg-slate-50/50 py-10 sm:py-14 lg:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="mb-3 text-xs font-medium uppercase tracking-widest text-primary sm:mb-4 sm:text-sm">
            Contact
          </p>
          ...
          <div className="mt-6 flex flex-col gap-2 sm:mt-8 sm:flex-row sm:flex-wrap sm:gap-3">
            <Button
              asChild
              className={`${btnRect} bg-primary text-primary-foreground shadow-[0_10px_24px_-12px_hsl(var(--primary))] hover:bg-primary/90`}
            >
                ...
                <div className="rounded-2xl border border-slate-200/90 bg-white p-5 shadow-sm sm:p-6 lg:p-7">
                  ...
                  <ul className="mt-5 space-y-4 text-sm leading-relaxed text-slate-600 sm:text-[0.9375rem] lg:mt-6 lg:space-y-4">
                    ...
                    <li className="flex gap-3">
                      ...
                      <a href={`tel:${phone}`} className="font-medium tabular-nums text-slate-700 hover:text-primary">
                        {phoneDisplay}
                      </a>
                    </li>
                    <li className="flex gap-3">
                      <Mail className="mt-0.5 h-4 w-4 shrink-0 text-primary" aria-hidden />
                      <a href={`mailto:${email}`} className="break-all font-medium text-slate-700 hover:text-primary">
                        {email}
                      </a>
                    </li>
