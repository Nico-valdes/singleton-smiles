...
export const dentalHygienists: TeamMember[] = [
  ...
  },
  {
    name: "Megan",
    role: "Dental Hygienist",
    bio: "Megan is a recent graduate of Jackson College where she earned her Associate of Applied Science in Dental Hygiene. She is certified in CPR, local anesthetic, and nitrous oxide administration, and is committed to delivering high‑quality, patient‑centered care. She has a passion for helping patients feel comfortable, confident, and well‑cared for in the dental chair. Outside of the office, she enjoys spending time with her family and friends, getting outdoors, and golfing whenever she can.",
  },
  {
    name: "Michelle",
    role: "Dental Hygienist",
